        ...
        <div className='addItem-content'>
          <p className='add-item-header'> Add Item</p>
            ...
            <div className='item-btn-container'>
                <button className='item-btn' disabled ={redirect}>
                  <span>{loadData ? <span className='reg-txt'> Redirecting... <div className="loader"> </div></span> 
                  : <span> Add Item</span>}</span></button>
